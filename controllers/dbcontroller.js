...
exports.postrect = function(req, res, next) {
    let sql = `INSERT INTO rects (width, height, color, freq, border, borderradius, font) VALUES (${req.body.width}, ${req.body.height}, '${req.body.color}', ${req.body.freq}, ${req.body.border}, ${req.body.borderradius}, '${req.body.font}');`;
    mysqllib.executeQuery(sql).then((d) => {
        res.redirect("/");
    });
}
